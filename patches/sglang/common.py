...
def evict_from_tree_cache(tree_cache: BasePrefixCache | None, num_tokens: int):
    ...
    if hasattr(allocator, "full_available_size"):
        ...
        if full_available_size < num_tokens or swa_available_size < num_tokens:
            ...
            # Eviction sync with ContextPilot is now handled via callback registered on RadixCache
    else:
        # Standard allocator
...
def create_contextpilot_eviction_callback():
    ...
    def eviction_callback(evicted_request_ids: set):
        ...
        # These are not tracked by ContextPilot and would cause "not_found" noise
        filtered_ids = {
